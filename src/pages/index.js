...
const data = {
  ...
  projects: [
    {
      ...
      libraries: ['Express.JS', 'Okta', 'React', 'react-vis', 'PostgresQL'],
      githubUrl: '',
      repositoryUrl: '',
      start: {
        year: null,
    ...
    },
    {
      ...
      languages: ['TypeScript', 'Batchfile', 'HTML', 'JavaScript', 'CSS'],
      libraries: ['RxJS', 'React', 'Ionic', 'Firebase'],
    ...
    },
    {
      ...
      libraries: ['Styled Components', 'React Scroll Parallax', 'Gatsby'],
    ...
    },
    {
      ...
      description:
        'Purely  client side application made with Ionic and StencilJS. A wage calculator that implements an algorithm which takes in various parameters about college professors and calculates prospective wage differences before and after signing a new contract with their college. ',
      ...
      summary:
        'A wage calculator made for Koach LaOvdim (Power to the Workers) organization.',
      primaryLanguage: 'TypeScript',
      languages: ['CSS', 'TypeScript', 'HTML'],
      libraries: ['StencilJS', 'Ionic'],
    ...
    },
    {
      name: 'new_agra_site',
      description:
        'A Gatsby static website for Agra Planning and Consulting LTD. Contentful is used as a CMS. This is one of my first projects, which taught me a lot about deploying a live site, SEO, performance and more.  ',
    ...
    },
    {
      ...
      libraries: ['React', 'Deck of Cards API', 'Recoil'],
    ...
    },
    {
      ...
      primaryLanguage: 'JavaScript',
      languages: ['JavaScript', 'CSS', 'SCSS', 'HTML', 'TypeScript'],
      libraries: [
        'Auth0',
        'MongoDB',
        'Ionic - Angular',
  ...
  work: [
    {
      ...
      endDate: '',
      summary:
        'As a full stack developer I took on tasks that span across our tech stack and activities',
      highlights: [
    ...
    },
    {
      ...
      endDate: '',
      summary:
        ' A governmental funded project to enhance circular economy in various industries throughout Israel.',
      highlights: [
  ...
  education: [
    ...
    },
    {
      ...
      courses: [],
      description:
        'Graduated summa cum laude, with a perfect score on my thesis paper. Majored in political theory and philosophical and mathematical logic.',
      activities: '',
      start: {
        year: null,
        month: null,
    ...
    <div>
      ...
      <main>
        <Home
          ...
          label={'Web Developer'}
        />
        <About animeClass={getAnimeClass(1)} summary={data.basics.summary} />
        <Portfolio animeClass={getAnimeClass(2)} projects={data.projects} />
        <Skills
